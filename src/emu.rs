...
pub fn emulate_8080(state: &mut State8080, _iteration: i32) -> u8 {
    ...
    // crate::disasm::disassemble_8080_op(state.memory, state.pc);
    state.pc += 1;
    ...
    match code {
        ...
        0x03 => unimplemented_instruction(),
        ...
        0x07 => unimplemented_instruction(),
        ...
        0x16 => unimplemented_instruction(),
        ...
        0x1f => unimplemented_instruction(),
        ...
        0x2a => unimplemented_instruction(),
        0x2b => unimplemented_instruction(),
        0x2c => unimplemented_instruction(),
        0x2d => unimplemented_instruction(),
        0x2e => unimplemented_instruction(),
        0x2f => unimplemented_instruction(),
        0x30 => unimplemented_instruction(),
        0x31 => {
            // LXI SP, b16
            state.sp = (state.memory[state.pc + 1] as u16).wrapping_shl(8) | (state.memory[state.pc] as u16);
            state.pc += 2;
        }
        0x32 => {
            // STA adr
            let offset = (state.memory[state.pc + 1] as u16).wrapping_shl(8) | (state.memory[state.pc] as u16);
            write_mem(state, offset, state.a);
            state.pc += 2;
        }
        0x33 => unimplemented_instruction(),
        0x34 => unimplemented_instruction(),
        0x35 => {
            // DCR M
        ...
        0x37 => unimplemented_instruction(),
        ...
        0x3c => unimplemented_instruction(),
        0x3d => {
            // DCR A
        ...
        0x4f => unimplemented_instruction(),
        ...
        0x57 => unimplemented_instruction(),
        ...
        0x5f => unimplemented_instruction(),
        ...
        0x67 => unimplemented_instruction(),
        ...
        0x78 => unimplemented_instruction(),
        0x79 => unimplemented_instruction(),
        0x7a => { // MOV D, A
            state.a = state.d;
        }
        0x7b => { // MOV E, A
        ...
        0xa8 => unimplemented_instruction(),
        ...
        0xb0 => unimplemented_instruction(),
        ...
        0xb6 => unimplemented_instruction(),
        ...
        0xc4 => unimplemented_instruction(),
        0xc5 => { // PUSH B
        ...
        0xd0 => unimplemented_instruction(),
        0xd1 => {
            // POP D
        ...
        0xd8 => unimplemented_instruction(),
        ...
        0xe3 => unimplemented_instruction(),
        ...
        0xe9 => unimplemented_instruction(),
        ...
        0xf6 => unimplemented_instruction(),
